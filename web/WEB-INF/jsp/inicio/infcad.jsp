                        ...
                        <div class="art-content-layout-row">
                            <div class="art-layout-cell art-content">
                                <article class="art-post art-article"><p><br></p>                                                                                                                                                                                       
                                         ...
                                         <p style="text-align: justify; margin-right: 10px;"><span style="font-family: 'Palatino Linotype';"><span style="font-size: 16px;">Diseño Asistido por Computador, permite al diseñador crear imágenes de partes, circuitos integrados, ensamblajes y modelos de prácticamente todo lo que se imagine en una estación gráfica conectada a un computador. Estas imágenes se transforman en la base de un nuevo diseño, o en la modificación de uno previamente existente. Asignándoles propiedades geométricas, cinéticas, del material entre otras, mejorando así el diseño sobre papel.Logrando así una mayor velocidad en el diseño, al existir la posibilidad de corregir, encargándose el computador de recalcular el dibujo. Existen sistemas CAD especiales para aplicaciones mecánicas, electrónicas y de arquitectura, las cuales permiten una mejor interrelación con sus respectivos sistemas CAE (Ingeniería Asistida por Computador).</span>&nbsp;&nbsp;</span></p><p><br></p>                                                                        
                                </article>                                     
                           </div>                                                                          

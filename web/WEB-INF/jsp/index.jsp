                                    ...
                                    <div class="art-postcontent art-postcontent-0 clearfix">
                                        <td style="background-color:rgb(69, 82, 112);padding-top:10px;padding-right:16px;padding-bottom:0;padding-left:10px;border-top-width:0;border-right-width:0;border-bottom-width:0;border-left-width:0;"><p style="text-align: center; "><span style="color: rgb(228, 235, 236); ">
                                            <span style="border-collapse: collapse; color: rgb(50, 146, 205); font-size: 28px; font-weight: bold;"
                                                <span style="text-shadow: rgba(23, 23, 23, 0.976563) 0px 0px 6px; color: rgb(226, 52, 29); font-size: 16px; "><span style="color: rgb(72, 89, 158); font-family: 'Arial Black'; text-shadow: rgb(255, 255, 255) 1.9px 1.9px 0px, rgba(23, 23, 23, 0.792969) 2.6px 2.6px 0px; ">BIENVENIDOS A OPEN CNC</span><span style="font-family: Arial; text-shadow: rgb(255, 255, 255) 1.4px 1.4px 0px, rgba(23, 23, 23, 0.792969) 2.1px 2.1px 0px; ">&nbsp;</span></span></span></p>
                                                <span style="border-collapse: collapse; color: rgb(50, 146, 205); font-size: 22px; font-weight: bold;"
                                                <span style="text-shadow: rgba(23, 23, 23, 0.976563) 0px 0px 6px; color: rgb(226, 52, 29); font-size: 14px; "><span style="color: rgb(66, 102, 104); font-family: 'Arial Black'; text-shadow: rgb(255, 255, 255) 1.9px 1.9px 0px, rgba(23, 23, 23, 0.792969) 2.6px 2.6px 0px; ">CAD-CAM</span><span style="font-family: Arial; text-shadow: rgb(255, 255, 255) 1.4px 1.4px 0px, rgba(23, 23, 23, 0.792969) 2.1px 2.1px 0px; ">&nbsp;</span></span></span></p>                   

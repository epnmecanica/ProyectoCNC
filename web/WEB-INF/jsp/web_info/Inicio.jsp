            ...
            <nav class="art-nav">
                ...
                <div class="art-sheet clearfix">
                            ...
                            <div class="art-content-layout-row">
                                ...
                                <div class="art-layout-cell art-sidebar1">
                                    ...
                                    <div class="art-block clearfix">
                                        ...
                                        <div class="art-blockcontent"><p style="text-align: center;"><img width="224" height="149" alt="" class="art-lightbox" src="../resources/images/fotosinfo/rompecabezas.jpg" style="border-top-style: solid; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; border-top-color: rgb(214, 220, 218); border-right-color: rgb(214, 220, 218); border-bottom-color: rgb(214, 220, 218); border-left-color: rgb(214, 220, 218); border-top-width: 3px; border-right-width: 3px; border-bottom-width: 3px; border-left-width: 3px;"></p><p style="text-align: center;"><a href="usuario/login.htm" class="art-button">Inicia Aqui</a></p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <footer class="art-footer">
                        <a title="RSS" class="art-rss-tag-icon" style="position: absolute; bottom: 10px; left: 6px; line-height: 36px;" href="#"></a><div style="position:relative;padding-left:10px;padding-right:10px"><br>Saber para Ser<br></div>
                        <div style="position:relative;padding-left:10px;padding-right:10px"><br></div>    
                    </footer>
                </div>
            </div>
    </body>

...
function icons(){
 ...
 function loadIcons(gd){
        ...
        this.iok.translate(iconsArray[25],0).show();
          ...
          icut.mousemove(function(){
              icut.attr({fill: colors, stroke: "none"});
          }).click(function () {
              avisoEntrada('Vas a usar la herramienta de corte');
             gd.setMode(gd.MODES.CUT);
          });
 }
